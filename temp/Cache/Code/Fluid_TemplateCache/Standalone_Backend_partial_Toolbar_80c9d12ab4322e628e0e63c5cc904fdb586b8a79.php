<?php
class FluidCache_Standalone_Backend_partial_Toolbar_80c9d12ab4322e628e0e63c5cc904fdb586b8a79 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '<header class="toolbar">
	<span class="toolbar_user">Welcome ';
...
$output0 .= '<a><i></i> Profile</a> <a>Logout</a></span>
	<nav class="toolbar__nav">
		<li>
			<a>Cache</a>
			<ul>
				<li><a>Clear frontend cache</a></li>
				<li><a>Clear syslog</a></li>
				<li><a>Clear all caches</a></li>
			</ul>
		</li>
		<li>
			<a>Dashboard</a>
