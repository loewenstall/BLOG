<?php
class FluidCache_Standalone_Post_action_list_fde4472147511dab996034d405a022503453316d extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments5 = array();
$arguments5['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.hidden', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments40 = array();
$arguments40['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.hidden', $renderingContext);
