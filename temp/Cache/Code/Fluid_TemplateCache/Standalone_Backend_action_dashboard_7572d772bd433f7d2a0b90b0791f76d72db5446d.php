<?php
class FluidCache_Standalone_Backend_action_dashboard_7572d772bd433f7d2a0b90b0791f76d72db5446d extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
return \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'publicPosts', $renderingContext);
};
...
return \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'hiddenCount', $renderingContext);
};
$viewHelper12 = $self->getViewHelper('$viewHelper12', $renderingContext, 'TYPO3\Fluid\ViewHelpers\CountViewHelper');
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\CountViewHelper
$arguments47 = array();
$arguments47['subject'] = NULL;
$renderChildrenClosure48 = function() use ($renderingContext, $self) {
return \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'hiddenCount', $renderingContext);
};
$viewHelper49 = $self->getViewHelper('$viewHelper49', $renderingContext, 'TYPO3\Fluid\ViewHelpers\CountViewHelper');
...
$output37 .= $viewHelper49->initializeArgumentsAndRender();
