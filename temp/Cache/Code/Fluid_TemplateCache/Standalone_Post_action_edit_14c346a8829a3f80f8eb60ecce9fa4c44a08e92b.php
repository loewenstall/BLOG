<?php
class FluidCache_Standalone_Post_action_edit_14c346a8829a3f80f8eb60ecce9fa4c44a08e92b extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '</h2>
		...
		<form name="editForm" action="foo" method="post">
			<div class="form__row">
				<input type="text" name="edit_post[title]" value="';
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments7 = array();
...
$output0 .= '" />
			...
			<div class="form__row">
				<input type="text" name="edit_post[shortname]" value="';
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments10 = array();
